...
class CustomDropdownField extends StatelessWidget {
  ...
  final String hint; // Placeholder du dropdown
        ...
        builder: (context, value, _) {
          return Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color: AppColors.btnPrimary, // Couleur de la bordure
                width: 1,          // Épaisseur de la bordure
              ),
            ),
            child: DropdownButtonHideUnderline(
              child: DropdownButton<String>(
                isExpanded: true, // Permet à la liste de prendre toute la largeur
                hint: Text(
                  hint,
